...
/* 339 */
  { RPL_WHOISMARKS, "%s :is marked: %s", "339" },
/* 340 */
  { RPL_USERIP, ":", "340" },
/* 341 */
...
/* 342 */
  { 0 },
/* 343 */
  { RPL_WHOISKILL, "%s :is Kill listed on %s", "343" },
/* 344 */
  { 0 },
/* 345 */
...
/* 541 */
  { 0 },
/* 542 */
  { RPL_STATSSHUN, "%c %s%s%s %Tu %Tu %Tu %s%c :%s", "542" },
/* 543 */
...
/* 904 */
  { ERR_SASLFAIL, ":SASL authentication failed%s", "904" },
/* 905 */
  { ERR_SASLTOOLONG, ":SASL message too long", "905" },
/* 906 */
  { ERR_SASLABORTED, ":SASL authentication aborted", "906" },
/* 907 */
  { ERR_SASLALREADY, ":You have already completed SASL authentication", "907" },
/* 908 */
  { ERR_SASLMECHS, "%s :are available SASL mechanisms", "908" },
/* 909 */
  { 0 },
/* 910 */
  { 0 },
